...
public class Constants {
    ...
    public static final String JAVA_DIR_PATH = OS_PROJECTS_PATH + "app/src/main/java/com/ng/ngleetcode/code";
    public static final String ASSETS_DIR_PATH = OS_PROJECTS_PATH + "app/src/main/assets";
