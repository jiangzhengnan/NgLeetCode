...
public class ObservableFlatMapIterable<T, U> extends Observable<U> {
  ...
  public ObservableFlatMapIterable(ObservableSource<T> source,
      Function<? super T, Iterable<U>> function) {
    this.source = source;
